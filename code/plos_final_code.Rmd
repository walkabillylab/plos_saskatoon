...
```{r}
plos_colors <- c("Low" = "#fecc5c", "Medium" = "#fd8d3c",
                 "High" = "#f03b20", "Very High" = "#bd0026")
```
...
print(p_class)
ggsave("/Users/patysalazar/Desktop/MSc/PLOS/plos/maps/PLOS_Saskatoon_classes.png",
...
p_cont <- ggplot(da_map) +
  ...
  scale_fill_gradientn(
    colours = c("#fecc5c", "#fd8d3c", "#f03b20", "#bd0026"),
    na.value = "white",
    name = "PLOS density\n(points / km²)"
  ) +
  coord_sf(xlim = c(bbox_sask["xmin"], bbox_sask["xmax"]),
...
print(p_cont)
ggsave("/Users/patysalazar/Desktop/MSc/PLOS/plos/maps/PLOS_Saskatoon_continuous.png",

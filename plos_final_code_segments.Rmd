...
out_csv  <- "V:/canadian_pedestrian_network/sk_segment_plos.csv"
```
...
write_sf(ped_scored, "V:/canadian_pedestrian_network/Saskatoon_ped_PLOS_segments.gpkg")
...
```{r}
ggsave("V:/canadian_pedestrian_network/PLOS_Saskatoon_segments_highres.jpg",
